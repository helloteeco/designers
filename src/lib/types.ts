...
export interface FloorPlan {
  ...
  isPrimary?: boolean;
  /** Set when this plan was generated by the in-app Floor Plan Builder. The
   *  URL is a data: SVG rendered from this structured data on save. Keep the
   *  raw data so a designer can re-open and edit with the builder. */
  builderData?: import("./floor-plan-builder").BuilderPlan;
}
